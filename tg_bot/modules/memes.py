...
COPYPASTA_HANDLER = DisableAbleCommandHandler("cp", copypasta)
CLAPMOJI_HANDLER = DisableAbleCommandHandler("clap", clapmoji, admin_ok=True)
BMOJI_HANDLER = DisableAbleCommandHandler("b", bmoji, admin_ok=True)
